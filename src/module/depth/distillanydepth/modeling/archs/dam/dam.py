...
from src.module.depth.distillanydepth.modeling.backbones.vit.ViT_DINO import (
    vit_base,
    vit_large,
)
from src.module.depth.distillanydepth.modeling.backbones.vit.ViT_DINO_reg import (
    vit_giant2_reg,
    vit_large_reg,
)
from src.module.depth.og_dpt_utils.transform import (
    NormalizeImage,
    PrepareForNet,
    Resize,
)
