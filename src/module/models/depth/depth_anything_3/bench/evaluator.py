...
from module.models.depth.depth_anything_3.bench.print_metrics import MetricsPrinter
from module.models.depth.depth_anything_3.bench.registries import MV_REGISTRY
from module.models.depth.depth_anything_3.utils.constants import EVAL_REF_VIEW_STRATEGY
from module.models.depth.depth_anything_3.utils.parallel_utils import parallel_execution
...
class Evaluator:
    ...
    def _compute_pose_with_gt(
        ...
        """
        from module.models.depth.depth_anything_3.bench.dataset import (
            _wait_for_file_ready,
        )
        from module.models.depth.depth_anything_3.bench.utils import compute_pose
        from module.models.depth.depth_anything_3.utils.geometry import as_homogeneous
...
if __name__ == "__main__":
    ...
    from module.models.depth.depth_anything_3.cfg import load_config
  ...
  python -m depth_anything_3.bench.evaluator eval.print_only=true
    ...
    if print_only:
        ...
        if len(gpu_list) > 1 and not is_worker:
            ...
            from module.models.depth.depth_anything_3.api import DepthAnything3
